...
export default function ServiceCard({ icon: Icon, title, description, benefits = [], cta, onClick }) {
  return (
    <motion.div
      whileHover={{ y: -6 }}
      onClick={onClick}
      className="p-8 rounded-3xl border border-white/10 backdrop-blur-xl bg-white/5 shadow-premium flex flex-col cursor-pointer"
    >
